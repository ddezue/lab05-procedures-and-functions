...
int sumOfAbsoluteValues(const int* array, int arraySize) {
  double sum = 0;
  int elementIndex;
...
int main() {
  ...
  printf("\n");
  sumX = sumOfAbsoluteValues(arrayX, sizeOfTheArrayX);
  sumY = sumOfAbsoluteValues(arrayY, sizeOfTheArrayY);
  sumZ = sumOfAbsoluteValues(arrayZ, sizeOfTheArrayZ);

  printf("Sum of modules of the array elements X: %d\n", sumX);
  printf("Sum of modules of the array elements Y: %d\n", sumY);
  printf("Sum of modules of the array elements Z: %d\n", sumZ);
